...
class core_renderer extends \core_renderer {
    ...
    public function custom_menu_user() {
		...
		if ($this->page->pagelayout != 'login') {
		    ...
		    $userpic = '<em>'.$this->getfontawesomemarkup('sign-in').' Comptes invités';
		    $usermenu .= html_writer::link($CFG->wwwroot.'/local/login-multi/',$userpic2, array('class'=>'loginurl'));
            	    $branchlabel2 = '<em>'.$this->getfontawesomemarkup('sign-in').' Comptes invités';
                    $branchurl2 = new moodle_url('/local/login-multi/index.php');
                    $usermenu .= html_writer::tag('li', html_writer::link($branchurl2, $branchlabel2));
		    /* Render Help Linka*/
